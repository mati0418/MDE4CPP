...
SET CMAKE_HOME=C:\tools\cmake-3.22.3-windows-x84_64

REM path to compiler home folder
SET COMPILER_HOME=C:\tools\mingw64\mingw64

REM path to java development kit
SET JAVA_HOME=C:\Java\jdk-16
...
REM SET CPP_IDE_EXECUTABLE=C:\MyEclipseCPP\eclipse.exe
